  ...
  <div class="merchandiseControl">
      <div class="operate">
        ...
        <div style="margin-top:10px">
          ...
          <el-tag type="success" @click.native="upMerchandise">上架</el-tag>
          <el-tag type="info" @click.native="downMerchandise">下架</el-tag>
          <el-tag type="warning" @click.native="editMerchandiseGroup">修改分组</el-tag>
          <el-tag type="danger" @click.native="delMerchandise">删除</el-tag>
          <el-tag  @click.native="getData">清空所有筛选</el-tag>
        </div>
      </div>
      <el-table
      ref="multipleTable"
