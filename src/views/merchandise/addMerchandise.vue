<template>
  <div class="addMerchandise">
    <div class="baseinfo">
      <div class="title">
      <div class="title-des"><span >基本信息</span> 
    <el-popover
      placement="top-start"
      title="标题"
      width="600"
    ...
    <div class="PriceAndInventory">
      <div class="title">
      <div class="title-des"><span >价格库存</span> 
    <el-popover
      placement="top-start"
      title="标题"
      width="600"
    ...
    <div class="other-info">
      <div class="title">
      <div class="title-des"><span >其他信息</span> 
        <el-popover
          placement="top-start"
          title="标题"
          width="600"
    ...
    <div class="save-metchandise"><el-button>保存按钮</el-button></div>
  </div>
</template>
